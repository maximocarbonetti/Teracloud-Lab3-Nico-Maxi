...
resource "aws_codepipeline" "this" {
  ...
  # Al llegar a esta etapa, CodePipeline publica un aviso en el topico SNS y la
  # ejecucion queda en espera hasta que alguien apruebe o rechace desde la
  # consola.
  dynamic "stage" {
    ...
    content {
      ...
      action {
        ...
        configuration = {
          ...
          CustomData      = "Revisar el build antes de desplegar en ${var.ecs_cluster_name}. La imagen ya esta publicada en ECR; aprobar actualiza el servicio ${var.ecs_service_name}."
